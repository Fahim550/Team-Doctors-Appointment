...
export default function AdminLayout({ children }) {
  ...
  return (
    <div className=" bg-gray-50 dark:bg-gray-900 overflow-x-hidden">
      ...
      {/* <Navbars className="fixed left-0 right-0 top-0 z-50"/> */}
      {login ? (
        <Layout>
          <aside
            className="absolute top-10 left-0 z-40 w-64 h-screen pt-14 transition-transform -translate-x-full bg-white border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
            aria-label="Sidenav"
            id="drawer-navigation"
          >
            <div className=" py-5 px-3 h-full bg-white dark:bg-gray-800">
          ...
          <main className="p-4  h-auto ">{children}</main>
        </Layout>
      ) : (
        <Home />
      )}
